 ...
 */
package org.bc_tinyradius.packet;
...
import org.bc_tinyradius.attribute.VendorSpecificAttribute;
import org.bc_tinyradius.dictionary.AttributeType;
import org.bc_tinyradius.dictionary.DefaultDictionary;
import org.bc_tinyradius.dictionary.Dictionary;
import org.bc_tinyradius.util.RadiusException;
import org.bc_tinyradius.util.RadiusUtil;
...
public class RadiusPacket {
	 ...
	 *            name of the attribute, for example "NAS-Ip-Address"
	 * @param value
	 *            value of the attribute such as state
	 * @throws IllegalArgumentException
	 *             if type name is unknown
	 */
